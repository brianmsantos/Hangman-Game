...
//Once generator has chosen the random word then it will load the word and provide the number 
//of spots as a hint to the user. 



//Click a letter to start, once the letter is chosen it will either generate it in the spot where it belongs or it will make the guess counter decrease. 
